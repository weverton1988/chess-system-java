...
public class ChessMatch {
	...
	public ChessPiece perfomrChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
	...
	private void validateTargetPosition(Position source, Position target) {
		if (!board.piece(source).possibleMove(target)) {
			throw new ChessException("The chose piece can't move to target posotion");
		}
	}
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalStateException("There is no " + color + " king on tge board");
	}
